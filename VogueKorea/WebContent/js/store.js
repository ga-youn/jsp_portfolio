...
$(function () {
    ...
    /*상품 갯수 보이기*/
    var n = $( '.item_gallery_type > ul > li' ).length;
    //console.log(n);
    $( 'span.pick_list_num > strong' ).append(n);
    /*페이지 네비게이션*/
    ...
    /*가격순으로 상품정렬
    var ascending = true;
    var $myList = $('.item_gallery_type ul');

   
    var $list = $myList.find('li .item_price > span');
    var sortList = Array.prototype.sort.bind($list);//배열 재정렬
