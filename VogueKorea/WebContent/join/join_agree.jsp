...
<%@ include file="../header.jsp"%><!-- header삽입 -->
        ...
        <main>
            <section class="content_box">
                ...
                <form id="wrapContent" name="my_form" action="vogueKorea.vk?type=join_registerForm" method="post">
                    <fieldset>
                        <!--allAgree전체동의체크영역-->
                        <div class="titleBox allAgree_titleBox">
                            <input type="checkbox" id="allAgree_icon" class="checkbox_icon" value=""  name="check"  onclick="allCheckNCancel()"/>
                            <label for="allAgree_icon" >
                                <i class="fas fa-check-circle"></i>
                                <span >서비스 이용 약관, 개인정보 수집 및 이용동의에 모두 동의합니다.</span>
                                <span class="agreetext_2">(전체동의)</span>
                            </label>
                        </div>
                        ...
                        <!--약관동의1영역-->
                        <div class="titleBox">
                            <input type="checkbox" id="agree_icon1" class="checkbox_icon" name="check"onclick="memberAllClick()"/>
                            <label for="agree_icon1" >
                                <i class="fas fa-check-circle"></i>
                        ...
                        <div class="agreeContent">
                            ...
                            <br>제1조(목적) 표준약관 제10023호<br>
                            <br>
                            	이 약관은 두산매거진 회사(전자거래 사업자)가 운영하는 매거진샵 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br>
                            	※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」<br>
                            <br>
                            <br>
                           	 제2조(정의)<br>
                            <br>
                            ① "몰"이란 두산매거진 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
                            ...
                            ⑤ '재화'라 함은 "몰"에서 판매하는 정기구독을 의미하며, 정기구독이란 비용을 지불하고 일정기간 동안 정기간행물을 받아보는것을 의미합니다.<br>
                            <br>
                            <br>
                            ...
                            ① "몰"은 이용자로부터 재화 등을 반환받은 경우 3영업일 이내에 이미 지급받은 재화등의 대금을 환급합니다. 이 경우 "몰"이 이용자에게 재화등의 환급을 지연한 때에는 그 지연기간에 대하여 공정거래위원회가 정하여 고시하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.<br>
                            	이때 정기구독과 함께 받은 사은품은 미개봉 상태 및 사용흔적이 없어야 하고 판매가치에 문제가 없다고 판단되는 상태로 반환하여야 취소가 가능합니다. <br>
                        ...
                        <div class="titleBox">   
                            <input type="checkbox" id="agree_icon2" class="checkbox_icon" name="check" onclick="memberAllClick()"/> 
                            <label for="agree_icon2">
                            <i class="fas fa-check-circle"></i>
                        ...
                        <div class="titleBox">   
                            <input type="checkbox" id="agree_icon3" class="checkbox_icon" name="check" onclick="memberAllClick()"/> 
                            <label for="agree_icon3">
                            <i class="fas fa-check-circle"></i>
                            <span>선택적 개인정보 제 3자 제공(선택)</span>
                            </label>
                        </div>
                        <div class="agreeContent">  
                        - 제공받는 자 : 대화실업<br>
                        ...
                        - 보유/이용기간 : 회원탈퇴 후 5일까지<br><br>- 제공받는 자 : 공급사 판매자<br>
                        - 이용목적 : 판매자와 구매자의 거래의 원활한 진행, 본인의사의확인, 고객 상담 및 불만처리, 상품과 경품 배송을 위한 배송지 확인 등<br>
                        - 제공항목 : 구매자 이름, 전화번호, ID, 휴대폰번호, 이메일주소, 상품 구매정보, 상품 수취인 정보(이름, 주소, 전화번호)<br>
                        - 보유/이용기간 : 배송완료 후 한달	
                        </div>
                        <!--버튼영역-->
                        <div class="btn_box">
                           
                            <button type="button" class="btn_Prev" onclick="goPrevPage()">이전 <!--이전영역페이지-->
                            </button>
                            <!--<a href="#" onclick="this.href=goNextPage()">  -->
                            <button type="submit" class="btn_Next" onclick="goNextPage()">확인</button> 
